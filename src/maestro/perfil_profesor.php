    ...
    <div class=" flex justify-center items-center w-screen">
        <div class="bg-white p-8 rounded shadow-lg w-11/12 ">
            <div class="flex justify-between">
                <a href="./maestro_views.php" class="mb-5 flex items-center justify-center bg-blue-500 text-white px-4 w-20 py-2 rounded hover:bg-blue-600">Back</a>
                <a href="./view_perfil_editar.php" class="mb-5 flex items-center justify-center bg-blue-500 text-white px-4 w-20 py-2 rounded hover:bg-blue-600">editar</a>
            </div>
